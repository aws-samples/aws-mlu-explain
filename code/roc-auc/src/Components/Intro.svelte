<script>
  ...
  <path fill="white" transform="scale(0.051)" d="m558.77 267.66c-2.4492-60.551-52.5-109.02-113.57-109.02-7.0859 0-14.176 0.61328-21.086 
  ...
  <path fill="#7cd1ea" transform="translate(2.5, 2.2) scale(0.044)" d="m558.77 267.66c-2.4492-60.551-52.5-109.02-113.57-109.02-7.0859 0-14.176 0.61328-21.086 
  1.9258-28.613-33.426-71.398-53.375-115.32-53.375-72.363 0-134.05 50.664-148.4 121.19-51.891 8.9219-90.391 54.246-90.391 107.18v8.3984c0 59.938 
  48.824 108.76 108.85 108.76h357.18c51.801 0 93.977-42.176 93.977-93.977-0.003906-43.223-29.668-80.758-71.23-91.082z"/>
  </svg>`;
  const planeIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="${iconWidth}" height="${iconHeight}" viewBox="0 0 ${iconWidth} ${iconHeight}" >
    <path fill="white" transform="scale(0.05)" d="${planePath}"/>
 
    <path fill="#c9208a" transform="translate(2, 1) scale(0.049)" d="${planePath}"/>
 </svg>`;
</script>
...
<section>
  <p class="body-text">
    ...
    outputs (e.g. the consequences ({@html cloudIcon}) ({@html planeIcon}) of
    favoring False Positives over False Negatives, or vice versa). Left
    unmentioned were two closely-related concepts, the Receiver Operating
