...
<h1 class="body-header">Interpreting AUC</h1>
<p class="body-text">
...
<div id="error-chart" bind:offsetWidth={width} bind:offsetHeight={height}>
  ...
  >
    ...
    <path class="outline-line" d={accuracyPath(errorData)} />
    <path class="path-line" d={accuracyPath(errorData)} stroke="#c9208a" />
    <path class="outline-line" d={precisionPath(errorData)} />
    <path class="path-line" d={precisionPath(errorData)} stroke="#ab00d6" />

    <!-- chart labels -->
    <text
      id="error-text-precision"
      class="error-text"
      y={precisionScale(1)}
      x={xScale(12.35)}
      dominant-baseline="middle">Precision</text
    >
    <text
      id="error-text-accuracy"
      class="error-text"
      y={accuracyScale(0.79)}
      x={xScale(9.2)}
      dominant-baseline="middle">Accuracy</text
    >
