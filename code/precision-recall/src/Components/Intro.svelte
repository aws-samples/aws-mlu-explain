...
<br>
<p class='body-text'>
    The distinction between these four different prediction outcomes is often consequential,
    so it's very important to have a solid understanding of them!
</p>
<br>
<p class='body-text'>

  To motivate our problem, we'll pretend that we've trained a binary classification model to diagnose an individual as having cancer or not. 
