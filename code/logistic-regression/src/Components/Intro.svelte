<script>
  ...
  const z_eq =
    "\\begin{aligned} z = \\hat{\\beta_0} + \\hat{\\beta_1} x_1 + \\hat{\\beta_2} x_2 + ... + \\hat{\\beta_n} x_n \\end{aligned}";
</script>

<section>
  <p class="body-text">
    One broad category in machine learning is supervised learning, where the
    goal is to learn to predict an output given some inputs. The outcome may be
    numerical, or it may be categorical. In this article, we will discuss
