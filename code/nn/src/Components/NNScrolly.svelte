...
<h2 class="body-header">Building A Neural Network</h2>
<p class="body-text">
  To make neural networks easier to digest, let's build one up from the
  foundations. let's go through a quick, high-level introduction of how it
  works. We'll scroll through the core concepts of the algorithm at a
  high-level, and then delve into the details thereafter:
</p>
<br />
<section id="scrolly">
      ...
      <div class="step" data-index="2">
        <div class="step-content">
          <p>
            ...
            regression problem, that involves estimating the y-intercept and
            slope of our model, {@html katexify(`\\hat{\\beta_0}`, false)} and {@html katexify(
              `\\hat{\\beta_1}`,
              false
            )}.
            <br /><br />
