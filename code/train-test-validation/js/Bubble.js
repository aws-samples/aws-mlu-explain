...
export class Bubble {
  constructor(opts) {
    ...
    this.WIDTH =
      window.innerWidth < 800 ? windowWidth / 1.0 : windowWidth / 1.75;
    this.HEIGHT =
    ...
    // chart constants
    this.yGroupHeight =
      window.innerWidth >= 800 ? this.HEIGHT / 4.6 : this.HEIGHT / 4;
    this.yLabelHeight = 45;

    this.iconScale = window.innerWidth >= 800 ? 0.3 : 0.205; //26
    this.collideRadius = window.innerWidth >= 800 ? 16 : 10.5; //12.5

    this.radius = window.innerWidth >= 800 ? 7 : 4;
    ...
    this.groups = {
      ...
      test: {
        x: window.innerWidth >= 800 ? this.WIDTH / 5.5 : this.WIDTH - 100,
        y: this.yGroupHeight,
        fullname: "Test",
      },
      train: {
      ...
      validation: {
        x: window.innerWidth >= 800 ? this.WIDTH / 1.2 : this.WIDTH + 100,
        y: this.yGroupHeight,
        fullname: "Validation",
      },
      offscreen: {
  ...
  moveCenter() {
    ...
    function ticked(d) {
      ...
      // hull constants
      const padding = window.innerWidth >= 800 ? 20 : 16;
      ...
      self.hullText
        ...
        .attr("y", hullMinY)
        .attr("dy", window.innerWidth >= 800 ? "1.5rem" : 20);
    }
  }
  ...
  drawAxesLabels(feature) {
    ...
    if (feature === "neither") {
      ...
      this.svg
        ...
        .attr("dy", window.innerWidth >= 800 ? "1rem" : 30)
  ...
  redraw() {
    ...
    this.WIDTH = window.innerWidth < 800 ? windowWidth * 1 : windowWidth / 1.75;
    this.HEIGHT =
      window.innerWidth < 800
        ? window.innerHeight / 1.8
        : window.innerHeight / 1.95;
    ...
    this.groups = {
      ...
      test: {
        x: window.innerWidth >= 800 ? this.WIDTH / 5.5 : this.WIDTH / 5,
        y: this.yGroupHeight,
        fullname: "Test",
      },
      train: {
